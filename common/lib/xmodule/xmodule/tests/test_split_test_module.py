...
from xmodule.tests.test_partitions import StaticPartitionService, PartitionTestCase, MockUserPartitionScheme
...
class SplitTestModuleLMSTest(SplitTestModuleTest):
    ...
    def test_child(self, user_tag, child_url_name):
        self.user_service.set_course_tag(
            self.course_id, None, 'xblock.partition_service.partition_0', user_tag
        )
    ...
    def test_child_old_tag_value(self, _user_tag):
        ...
        self.user_service.set_course_tag(
            self.user_service.COURSE_SCOPE, None, 'xblock.partition_service.partition_0', '2'
        )
    ...
    def test_get_html(self, user_tag, child_content):
        self.user_service.set_course_tag(
            self.user_service.COURSE_SCOPE, None, 'xblock.partition_service.partition_0', user_tag
        )
