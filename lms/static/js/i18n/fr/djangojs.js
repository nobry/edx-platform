...
(function (globals) {
  ...
  django.catalog = {
    ...
    " learner is already white listed and not added to the exception ": " apprenant est d\u00e9j\u00e0 dans la liste de d\u00e9rogations et ne sera pas ajout\u00e9", 
    " learner is not enrolled in course and not added to the exception": " apprenant n'est pas inscrit dans le cours et ne sera pas ajout\u00e9 ", 
    " learner is successfully added to the exception list": "apprenant ajout\u00e9 avec succ\u00e8s \u00e0 la liste de d\u00e9rogations", 
    " learners are already white listed and not added to": " apprenants sont d\u00e9j\u00e0 dans la liste de d\u00e9rogations et ne seront pas ajout\u00e9s", 
    " learners are not enrolled in course and not added to": " apprenants ne sont pas isncrits dans le cours et ne seront pas ajout\u00e9s", 
    " learners are successfully added to exception list": "apprenants ajout\u00e9s avec succ\u00e8s \u00e0 la liste de d\u00e9rogations", 
    " learners do not exist in LMS and not added to the": " apprenants n'existent pas dans le LMS et ne seront pas ajout\u00e9s", 
    " record is not in correct format and not added to the exception": "enregistrement ne sont pas dans le bon format et non ajout\u00e9s dans les d\u00e9rogations", 
    ...
    "%(comments_count)s %(span_sr_open)scomments (%(unread_comments_count))s %(span_close)s": "%(comments_count)s %(span_sr_open)scommentaires (%(unread_comments_count))s commentaires non lus%(span_close)s", 
    ...
    "%(post_type)s posted %(time_ago)s by %(author)s": "%(post_type)s post\u00e9e %(time_ago)s par %(author)s", 
    "%(team_count)s Team": [
      "%(team_count)s Equipe", 
    ...
    "Add your post to a relevant topic to help others find it.": "Ajouter votre message \u00e0 un sujet pertinent afin d'aider les autres \u00e0 le trouver.", 
    ...
    "Always cohort content-specific discussion topics": "Toujours du contenu de sujets de discussion sp\u00e9cifiques pour la cohorte", 
    "Amount": "Montant", 
    ...
    "An error occurred when signing you in to %(platformName)s.": "Une erreur est survenue lors de votre connexion avec %(platformName)s.", 
    ...
    "Browse {sr_start} teams {sr_end}": "Naviguer {sr_start} \u00e9quipes {sr_end}", 
    "Bulk Exceptions": "D\u00e9rogations en lot", 
    "Bullet list": "Liste \u00e0 puces", 
    "Bulleted List (Ctrl+U)": "List \u00e0 Puces (Ctrl+U)", 
    "By default, submitted exams are available for review after the due date has passed. Select this option to keep exams hidden after that date.": "Par d\u00e9faut, les examens soumis sont disponibles pour r\u00e9vision apr\u00e8s que la date d'\u00e9ch\u00e9ance soit pass\u00e9e. S\u00e9lectionner cette option afin de laisser les examens cach\u00e9s apr\u00e8s cette date.", 
    "By: Community TA": "Par: Assistant d'enseignement de la communaut\u00e9", 
    ...
    "Cohort selected content-specific discussion topics": "Contenu des sujets de discussion sp\u00e9cifiques \u00e0 la cohorte s\u00e9lectionn\u00e9e", 
    "Cohorted": "Cohorte", 
    ...
    "Could not find a user with username or email address '<%= identifier %>'.": "Impossible de trouver un utilisateur ayant  un nom d'utilisateur ou l'adresse courriel '<%= identifier %>'.", 
    ...
    "Date Exception Granted": "Date \u00e0 laquelle la d\u00e9rogation fut accord\u00e9e", 
    "Date added": "Date ajout\u00e9e", 
    ...
    "Delete this %(xblock_type)s (and prerequisite)?": "Supprimer ce %(xblock_type)s (et pr\u00e9requis)?", 
    ...
    "Discussion Home": "Page d'acceuil des discussions", 
    "Discussion admins, moderators, and TAs can make their posts visible to all students or specify a single cohort.": "Les administateurs, les mod\u00e9rateurs et les assistants d'enseignement peuvent rendre leurs messages visibles \u00e9tudiants ou sp\u00e9cifier une seule cohorte.", 
    "Discussion topics; currently listing: ": "Sujets de discussion; \u00e0 l'affiche pr\u00e9sentement: ", 
    ...
    "Don't see your picture? Make sure to allow your browser to use your camera when it asks for permission.": "Vous ne voyez pas votre image? Soyez certain de permettre \u00e0 votre fureteur d'utiliser votre cam\u00e9ra lorsqu'il en demande la permission.", 
    "Donate": "Faire un don", 
    ...
    "Edit post title": "Editer le titre du message", 
    ...
    "Editing visibility for: %(title)s": "\u00c9diter la visibilit\u00e9 pour: %(title)s", 
    ...
    "Enrollment Opens": "Ouverture des inscriptions", 
    ...
    "Enter your question or comment": "Entrez votre question ou commentaire", 
    ...
    "Exam will be visible after due date": "L'examen sera vaisible apr\u00e8s la date d'\u00e9ch\u00e9ance", 
    "Exam will remain hidden after due date": "L'examen restera cach\u00e9 apr\u00e8s la date d'\u00e9ch\u00e9ance", 
    "Exception Granted": "D\u00e9rogation accord\u00e9e", 
    "Exit full browser": "Quitter le fureteur plein \u00e9cran", 
    "Expand All": "Tout d\u00e9velopper", 
    "Expand Instructions": "D\u00e9plier les instructions", 
    "Expand discussion": "D\u00e9velopper la discussion", 
    "Explain if other.": "Expliquer si autre.", 
    "Explanation": "Explication", 
    "Explicitly Hiding from Students": "Cacher explicitement aux \u00e9tudiants", 
    "Explore New XSeries": "Explorer les nouvelles XSeries", 
    "Explore XSeries Programs": "Explorer les programmes XSeries", 
    ...
    "Fill browser": "Remplir le fureteur", 
    ...
    "Generate a Certificate for all ": "G\u00e9n\u00e9rer une attestation pour tous les ", 
    "Generate a Certificate for all users on the Exception list": "G\u00e9n\u00e9rer une attestation pour tous les utilisateurs sur la liste de d\u00e9rogation", 
    "Generate certificates for all users on the Exception list who do not yet have a certificate": "G\u00e9n\u00e9rer les attestations pour tous les utilisateurs sur la liste de d\u00e9rogations qui n'ont pas encore d'attestation", 
    ...
    "Hide Exam After Due Date": "Cacher l'examen apr\u00e8s la date d'\u00e9ch\u00e9ance", 
    ...
    "If you make this %(xblockType)s visible to students, students will be able to see its content after the release date has passed and you have published the unit.": "Si vous rendez ce %(xblockType)s visible pour les \u00e9tudiants, les \u00e9tudiants seront en mesure de voir son contenu apr\u00e8s la date de sortie et la publication de l'unit\u00e9(s).", 
    ...
    "Learners see warnings when 20% and 5% of the allotted time remains. You can grant learners extra time to complete the exam through the Instructor Dashboard.": "Les apprenants voient des avertissements quand le temps imparti restant atteint 20% et 5%. Vous pouvez permettre du temps suppl\u00e9mentaire aux apprenants afin de compl\u00e9ter l'examen via le tableau de bord de l'instructeur.", 
    ...
    "No results found for %(original_query)s. ": "Aucun r\u00e9sultat trouv\u00e9 pour %(original_query)s. ", 
    ...
    "ORDER PLACED": "COMMANDES PASS\u00c9ES", 
    "Ok": "Ok", 
    ...
    "Password Reset Email Sent": "Le courriel de r\u00e9initialisation du mot de passe a \u00e9t\u00e9 envoy\u00e9", 
    "Password assistance": "Aide mot de passe", 
    "Password reset email sent. Follow the link in the email to change your password.": "Courriel de r\u00e9initialisation du mot de passe envoy\u00e9. Suivez le lien dans le courriel pour changer votre mot de passe.", 
    "Paste": "Coller", 
    ...
    "Please check your email to confirm the change": "Veuillez v\u00e9rifier votre courriel pour confirmer les changements", 
    ...
    "Please select a course date": "S'il vous pla\u00eet choisir une date de cours", 
    ...
    "Please verify that your webcam is connected and that you have allowed your browser to access it.": "V\u00e9rifiez que votre cam\u00e9ra est bien connect\u00e9e et que votre fureteur est autoris\u00e9 \u00e0 l'acc\u00e9der.", 
    "Post": "Poster", 
    ...
    "Related to: %(courseware_title_linked)s": "A propos de: %(courseware_title_linked)s", 
    ...
    "Select a prerequisite subsection and enter a minimum score percentage to limit access to this subsection.": "S\u00e9lectionner une sous-section pr\u00e9-requise et entrer un score minimum en pourcentage pour limiter l'acc\u00e8s \u00e0 cette sous-section.", 
    ...
    "Some content in this unit is visible only to particular content groups": "Du contenu dans cette unit\u00e9 n'est visible que pour des groupes de contenu sp\u00e9cifiques", 
    ...
    "Staff and Students": "\u00c9quipe p\u00e9dagogique et \u00e9tudiants", 
    "Start": "D\u00e9but", 
    ...
    "Started rescore problem task for problem '<%= problem_id %>' and student '<%= student_id %>'. Click the 'Show Background Task History for Student' button to see the status of the task.": "Le recalcul du score du probl\u00e8me '<%= problem_id %>' de l'\u00e9tudiant '<%= student_id %>' a commenc\u00e9. Cliquez sur le bouton 'Afficher l'historique des t\u00e2ches de l'\u00e9tudiant' pour voir l'\u00e9tat de la t\u00e2che.", 
    "Starts": "D\u00e9but", 
    ...
    "Student username/email field is required and can not be empty. ": "Le champ de nom d'utilisateur/courriel de l'\u00e9tudiant est requis et ne peut pas \u00eatre vide.", 
    "Students are added to this cohort automatically.": "Les \u00e9tudiants sont ajout\u00e9s automatiquement \u00e0 cette cohorte", 
    ...
    "Successfully started task to rescore problem '<%= problem_id %>' for all students. Click the 'Show Background Task History for Problem' button to see the status of the task.": "D\u00e9marrage de la t\u00e2che consistant \u00e0 recalculer le score du probl\u00e8me '<%= problem_id %>' pour tous les \u00e9tudiants effectu\u00e9 avec succ\u00e8s. Cliquez sur le bouton 'Montrer l'historique des t\u00e2ches pour le probl\u00e8me' pour voir l'\u00e9tat de la t\u00e2che.", 
    "Successfully started task to reset attempts for problem '<%= problem_id %>'. Click the 'Show Background Task History for Problem' button to see the status of the task.": "D\u00e9marrage de la t\u00e2che consistant \u00e0 r\u00e9initialiser les tentatives pour le probl\u00e8me '<%= problem_id %>' effectu\u00e9 avec succ\u00e8s. Cliquez sur le bouton 'Montrer l'historique des t\u00e2ches pour le probl\u00e8me' pour voir l'\u00e9tat de la t\u00e2che.", 
    ...
    "Textbook name is required": "Le nom du Textbook est requis", 
    ...
    "The name that is used for ID verification and appears on your certificates. Other learners never see your full name. Make sure to enter your name exactly as it appears on your government-issued photo ID, including any non-Roman characters.": "Le nom qui est utilis\u00e9 pour votre validation d'identit\u00e9 et qui appara\u00eetra sur vos attestations. Les autres apprenants ne voient jamais votre nom complet. Soyez certain de saisir votre nom exactement comme il appara\u00eet sur une pi\u00e8ce d'identit\u00e9 avec photo, incluant tout caract\u00e8re non romain.", 
    ...
    "There are invalid keywords in your email. Check the following keywords and try again:": "Votre courriel contient des mots-cl\u00e9s invalides. Consultez la liste de mots-cl\u00e9s ci-dessous et essayer de nouveau:", 
    ...
    "These settings include basic information about your account. You can also specify additional information and see your linked social accounts on this page.": "Ces param\u00e8tres incluent des informations de base \u00e0 propos de votre compte. Vous pouvez aussi sp\u00e9cifier des informations suppl\u00e9mentaires et voir vos comptes de m\u00e9dias sociaux li\u00e9s \u00e0 votre compte sur cette page.", 
    ...
    "This browser cannot play .mp4, .ogg, or .webm files.": "Ce fureteur ne peut pas lire les fichiers .mp4, .ogg, ou .webm", 
    ...
    "This content group is not in use. Add a content group to any unit from the {linkStart}Course Outline{linkEnd}.": "Ce groupe de contenu n'est pas utilis\u00e9. Ajouter un groupe de contenu \u00e0 toute unit\u00e9 \u00e0 partir du {linkStart}Plan de cours{linkEnd}.", 
    ...
    "This link will open in a new browser window/tab": "Ce lien s'ouvrira dans une nouvelle fen\u00eatre ou onglet de votre fureteur", 
    ...
    "To receive a certificate, you must also verify your identity before %(date)s.": "Pour recevoir une attestation, vous devez aussi valider votre identit\u00e9 avant %(date)s.", 
    ...
    "To review student cohort assignments or see the results of uploading a CSV file, download course profile information or cohort results on %(link_start)s the Data Download page. %(link_end)s": "Pour v\u00e9rifier les affectations de cohortes d'\u00e9tudiants ou voir les r\u00e9sultats de l'import du fichier CSV, t\u00e9l\u00e9chargez les informations du profil de cours ou les r\u00e9sultat des cohortes depuis  %(link_start)s la page de T\u00e9l\u00e9chargement des donn\u00e9es. %(link_end)s", 
    ...
    "Try using a different browser, such as Google Chrome.": "Essayez un fureteur diff\u00e9rent, Google Chrome par exemple.", 
    ...
    "Unlink This Account": "D\u00e9liez votre compte", 
    "Unlink your {accountName} account": "D\u00e9liez votre compte {accountName}", 
    ...
    "Upload a comma separated values (.csv) file that contains the usernames or email addresses of learners who have been given exceptions. Include the username or email address in the first comma separated field. You can include an optional note describing the reason for the exception in the second comma separated field.": "T\u00e9l\u00e9versez un fichier comma separated values (.csv) contenant les noms d'utilisateurs ou les adresses courriels d'apprenants qui ont re\u00e7u une d\u00e9rogation. Inclure le nom d'utilisateur ou l'adresses courriel dans le premier champ. Vous pouvez include une note optionnelle pour d\u00e9crire la raison de la d\u00e9rogation dans le deuxi\u00e8me champ.", 
    ...
    "View/Share Certificate": "Voir/Partager attestation", 
    "Viewing %s course": [
      "Voir %s cours", 
      "Voir %s cours"
    ], 
    ...
    "We had some trouble processing your request. Please ensure you have copied any ": "Nous avons eu des probl\u00e8mes \u00e0 traiter votre requ\u00eate. Soyez certain que vous avez copi\u00e9 tout ", 
    ...
    "We weren't able to send you a password reset email.": "Il ne nous a pas \u00e9t\u00e9 possible de vous envoyer un courriel de r\u00e9initialisation du mot de passe.", 
    "We're sorry, there was an error": "D\u00e9sol\u00e9, il y a eu une erreur", 
    "We've encountered an error. Refresh your browser and then try again.": "Nous avons rencontr\u00e9 une erreur. Rafra\u00eechissez votre fureteur puis r\u00e9essayer.", 
    ...
    "We've sent instructions for resetting your password to the email address you provided.": "Nous avons envoy\u00e9 les instructions pour r\u00e9initialiser votre mot de passe \u00e0 l'adresse courriel que vous avez fournie.", 
    "Web:": "Web :", 
    "Webcam": "Cam\u00e9ra", 
    ...
    "When you select \"Reset Your Password\", a message will be sent to the email address for your {platform_name} account. Click the link in the message to reset your password.": "En cliquant sur \"R\u00e9initialiser votre mot de passe\", un message sera envoy\u00e9 \u00e0 l'adresse courriel. Cliquez sur le lien dans le message pour r\u00e9initialiser votre mot de passe.", 
    "When your face is in position, use the camera button %(icon)s below to take your photo.": "Quand votre visage est en bonne position, utilisez le bouton camera %(icon)s ci-dessous afin de prendre votre photo.", 
    ...
    "XSeries Program Certificates": "Attestations du programme XSeries", 
    ...
    "You are not enrolled in any XSeries Programs yet.": "Vous n'\u00eates pas encore inscrit dans un programme XSeries.", 
    ...
    "You can add a username or email address to be added to the certificate exceptions white list.": "Vous pouvez ajouter un nom d'utilisateur ou une adresse courriel pouvant \u00eatre ajout\u00e9 \u00e0 la liste de d\u00e9rogation.", 
    ...
    "You can pay now even if you don't have the following items available, but you will need to have these by %(date)s to qualify to earn a Verified Certificate.": "Afin de vous qualifier, vous devrez fournir avant %(date)s votre photo ainsi qu'une photo d'identification officielle prises avec votre cam\u00e9ra.", 
    ...
    "You have earned certificates in %(completed_courses)s of the %(total_courses)s courses so far.": "Vou avez obtenus des attestations dans %(completed_courses)s sur un total de %(total_courses)s jusqu'\u00e0 maintenant.", 
    ...
    "You need a computer that has a webcam. When you receive a browser prompt, make sure that you allow access to the camera.": "Vous avez besoin d'un ordinateur dot\u00e9 d'une cam\u00e9ra. Lors que votre explorateur vous le demandera, assurez vous de lui donner l'autorisation d'acc\u00e9der \u00e0 la cam\u00e9ra.", 
    ...
    "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.": "Votre fureteur ne supporte pas l'acc\u00e8s direct au presse-papier. Veuillez utiliser les raccourcis clavier Ctrl + X / C / V \u00e0 la place.", 
    ...
    "Your import is in progress; navigating away will abort it.": "Votre import est en cours; changer de page annulerait celui-ci.", 
    ...
    "additions to the Exception list": "ajouts sur la liste de d\u00e9rogation", 
